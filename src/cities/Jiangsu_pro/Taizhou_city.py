...
class TaizhouCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '泰州市',
                     'province': 'Jiangsu',
                     'total_items_num': 11861 + 1500,
                     'each_page_count': 10,
                     'base_url': 'http://opendata.taizhou.gov.cn/oportal/catalog/index?page={page_num}',
                     }
        ...
        self.headers = {"Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,"
                        ...
                        "Accept-Encoding": "gzip, deflate", "Accept-Language": "zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,"
                                                                               "en-US;q=0.6",
                        "Cookie": "__utrace=be72d90449692b5eb451048c684913d1; "
                                  "OPENSESSION=09ce9fd1-d8c8-492b-b11a-4dee4f60f071", "Host": "opendata.taizhou.gov.cn",
                        "Proxy-Connection": "keep-alive", "Referer": "http://opendata.taizhou.gov.cn/oportal/catalog/",
    ...
    def extract_page_data(self, session_page, files_type):
        ...
        release_time = session_page.ele(
            'x://li[contains(text(),"发布时间")]/span[@class="text-primary"]').text
        update_time = session_page.ele(
            'x://li[contains(text(),"更新时间")]/span[@class="text-primary"]').text
