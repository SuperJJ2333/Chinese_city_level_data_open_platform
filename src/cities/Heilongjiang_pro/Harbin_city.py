...
class HaerbinCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '哈尔滨市',
                     ...
                     'total_items_num': 3426 + 500,
                     'each_page_count': 10,
                     'base_url': 'http://data.harbin.gov.cn/oportal/catalog/index?page={page_num}'
                     }
        ...
        self.headers = {
            ...
            "Host": "data.harbin.gov.cn", "Referer": "http://data.harbin.gov.cn/oportal/catalog/",
        ...
        for frame in frames_list:
            try:
                ...
                if not frame_url.startswith('http'):
                    frame_url = f'http://data.harbin.gov.cn{frame_url}'
                else:
                    frame_url = frame_url
...
if __name__ == '__main__':
    page = HaerbinCrawler(is_headless=True)
    page.run()
