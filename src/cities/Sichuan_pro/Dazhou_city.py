...
class DazhouCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '达州市',
                     'province': 'Sichuan',
                     'total_items_num': 2075,
                     'each_page_count': 10,
                     'base_url': 'https://data.shenyang.gov.cn/oportal/catalog/index?page={page_num}'
                     }

        api_city_info = {'name': '达州市_api',
                         'province': 'Sichuan',
                         'total_items_num': 3631,
                         'each_page_count': 10,
                         'base_url': 'http://www.dazhoudata.cn/oportal/api/index?page={page_num}',
                         'is_api': 'True'
                         }
        ...
        if self.is_api:
            self.headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Cookie":"OPENSESSION=669babe4-b1f6-42f1-9849-4ef656d056ff","Host":"www.dazhoudata.cn","Referer":"http://www.dazhoudata.cn/oportal/api/","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0"}
        else:
            self.headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"max-age=0","Connection":"keep-alive","Cookie":"OPENSESSION=669babe4-b1f6-42f1-9849-4ef656d056ff","Host":"www.dazhoudata.cn","Referer":"http://www.dazhoudata.cn/oportal/api/","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0"}
...
if __name__ == '__main__':
    page = DazhouCrawler(is_headless=True)
    page.run()
