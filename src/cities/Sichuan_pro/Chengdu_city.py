...
class ChengduCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        ...
        self.headers = {
            ...
            "Cookie": "_gscu_446546907=190012483pmkb352; OPENSESSION=67ea03df-fa2a-4e2b-8ebd-4ae40348cc6a; _gscbrs_446546907=1; Hm_lvt_c3f009f814f701e8fad8a17f9682ec79=1719001249,1719047025; __utrace=97e75b3c70856dab62929216e8bfe179; _gscs_446546907=190470241y4qok52|pv:3; Hm_lpvt_c3f009f814f701e8fad8a17f9682ec79=1719048257",
            "Host": "data.chengdu.gov.cn", "Referer": "https://data.chengdu.gov.cn/oportal/catalog/",
    ...
    def extract_data(self, session_page, page_num):
        data_list = []
        frames_list = session_page.eles('x://*[@id="app"]/div[2]/div[2]/div[3]/ul/li')
    ...
    def extract_page_data(self, session_page, files_type):
        ...
        frame = session_page.ele('x://*[@id="app"]/div[2]/div[2]/div/ul/li[1]/table')

        # 假定session_page是已经加载了HTML内容的对象
        title = session_page.ele('x://*[@id="app"]/div[2]/div[1]/div/div/div/div[1]/ul[1]/li/h4').text
        subject = session_page.ele(
            'x://*[@id="app"]/div[2]/div[1]/div/div/div/div[2]/ul/li[2]/span').text
        description = frame.ele('x://tr[7]/td[2]').text
        source_department = session_page.ele(
            'x://*[@id="app"]/div[2]/div[1]/div/div/div/div[2]/ul/li[1]/span').text

        release_time = session_page.ele(
            'x://*[@id="app"]/div[2]/div[1]/div/div/div/div[2]/ul/li[3]/span').text
        update_time = session_page.ele(
            'x://*[@id="app"]/div[2]/div[1]/div/div/div/div[2]/ul/li[4]/span').text
    ...
    @staticmethod
    def extract_api_page_data(session_page, files_type):
...
if __name__ == '__main__':
    page = ChengduCrawler(is_headless=True)
    page.run()
