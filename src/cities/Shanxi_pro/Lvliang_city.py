...
class LvliangCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '吕梁市',
                     'province': 'Shanxi',
                     'total_items_num': 54 + 100,
                     'each_page_count': 10,
                     'base_url': 'http://124.165.206.18:25012/oportal/catalog/index?page={page_num}'
                     }
        ...
        self.headers = {
            ...
            "Cookie": "__utrace=b9409bc9a941687a09436826254baae0", "Host": "124.165.206.18:25012",
            "Proxy-Connection": "keep-alive", "Referer": "http://124.165.206.18:25012/oportal/catalog/",
        ...
        for frame in frames_list:
            try:
                ...
                if not frame_url.startswith('http'):
                    frame_url = f'http://124.165.206.18:25012{frame_url}'
                else:
                    frame_url = frame_url
...
if __name__ == '__main__':
    page = LvliangCrawler(is_headless=True)
    page.run()
