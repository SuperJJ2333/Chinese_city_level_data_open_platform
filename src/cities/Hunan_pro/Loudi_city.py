...
class LoudiCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '娄底市',
                     'province': 'Hunan',
                     'total_items_num': 49 + 200,
                     'each_page_count': 10,
                     'base_url': 'http://data.hnloudi.gov.cn:51182/oportal/catalog/index?page={page_num}'
                     }

        super().__init__(city_info, is_headless)

        self.headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cookie":"yfx_c_g_u_id_10000062=_ck24061600005817600785666375531; yfx_f_l_v_t_10000062=f_t_1718467258750__r_t_1718467258750__v_t_1718467258750__r_c_0; __utrace=c7b4649d17c40916f1b0759b51282c85; OPENSESSION=49025b6b-6a04-46d7-a6da-543f0afad453","Host":"data.hnloudi.gov.cn:51182","Proxy-Connection":"keep-alive","Referer":"http://data.hnloudi.gov.cn:51182/oportal/catalog/","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36 Edg/125.0.0.0"}
        ...
        for frame in frames_list:
            try:
                ...
                if not frame_url.startswith('http'):
                    frame_url = f'http://data.hnloudi.gov.cn:51182{frame_url}'
                else:
                    frame_url = frame_url
...
if __name__ == '__main__':
    page = LoudiCrawler(is_headless=True)
    page.run()
