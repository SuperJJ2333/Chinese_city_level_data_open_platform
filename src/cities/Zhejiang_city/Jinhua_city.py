...
class JinhuaCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '金华市',
                     'province': 'Zhejiang',
                     'total_items_num': 918 + 200,
                     'each_page_count': 10,
                     'base_url': 'https://open.data.jinhua.gov.cn/jdop_front/channal/datapubliclist.do'
                     }

        super().__init__(city_info, is_headless)

        self.headers = {"Accept":"application/json, text/javascript, */*; q=0.01","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Content-Type":"application/x-www-form-urlencoded","Cookie":"visited=1; JSESSIONID=6C66B179992BEA278E6878EBF687E8C4; ZJZWFWSESSIONID=a9b6edf8-b830-43c3-94ed-c994aad98849","Host":"open.data.jinhua.gov.cn","Origin":"https://open.data.jinhua.gov.cn","Referer":"https://open.data.jinhua.gov.cn/jdop_front/channal/api_service.do","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","X-Requested-With":"XMLHttpRequest","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}

        self.params = 'pageNumber={page_num}&pageSize=10&type=2&domainId=&deptId=&regionId=&keyword=&searchString='
    ...
    def process_page(self, urls_list):
        ...
        headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"max-age=0","Cookie":"visited=1; JSESSIONID=6C66B179992BEA278E6878EBF687E8C4; ZJZWFWSESSIONID=a9b6edf8-b830-43c3-94ed-c994aad98849","Host":"open.data.jinhua.gov.cn","Sec-Fetch-Dest":"document","Sec-Fetch-Mode":"navigate","Sec-Fetch-Site":"none","Sec-Fetch-User":"?1","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    ...
    def extract_data(json_data):
        ...
        id_lists = []
        urls = re.findall(r'detail/api\.do\?iid=\d+', results)

        for url in urls:
            if 'https' not in url:
                url = 'https://open.data.jinhua.gov.cn/jdop_front/' + url
    ...
    def extract_page_data(self, session_page, item):
        title = session_page.ele('x://*[@class="sjxqTit1"]').text if session_page.ele('x://*[@class="sjxqTit1"]') else ''
        subject = session_page.ele('x://tr[td="数据领域"]/td[2]').text
        description = session_page.ele('x://tr[td[contains(text(),"要:")]]/td[2]').text
        source_department = session_page.ele('x://tr[td="数据提供单位"]/td[2]').text

        release_time = session_page.ele('x://tr[td="发布时间"]/td[4]').text
        update_time = session_page.ele('x://tr[td="更新时间"]/td[4]').text

        open_conditions = "申请开放"
        data_volume = int(session_page.ele('x://tr[td="数据条数"]/td[4]').text)
        file_types = ['api']
        is_api = 'True'
...
if __name__ == '__main__':
    page = JinhuaCrawler(is_headless=True)
    page.run()
