...
class WenzhouCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '温州市',
                     'province': 'Zhejiang',
                     'total_items_num': 1447 + 500,
                     'each_page_count': 10,
                     'base_url': 'https://data.wenzhou.gov.cn/jdop_front/channal/datapubliclist.do'
                     }
        ...
        self.headers = {"Accept": "application/json, text/javascript, */*; q=0.01",
                        ...
                        "Cookie": "JSESSIONID=E9FE91727178FDEB32271FA55C25411B; arialoadData=false",
                        "Host": "data.wenzhou.gov.cn", "Origin": "https://data.wenzhou.gov.cn",
        ...
        self.params = 'pageNumber={page_num}&pageSize=10&type=&domainId=0&deptId=&regionId=&keyword=&content=&searchString=&orderDefault=&isDownload=1&dimensionId=0&openState='
    ...
    def process_page(self, urls_list):
        ...
        headers = {
            ...
            "Cookie": "JSESSIONID=E9FE91727178FDEB32271FA55C25411B; arialoadData=false", "Host": "data.wenzhou.gov.cn",
            "Referer": "https://data.wenzhou.gov.cn/jdop_front/channal/data_public.do", "Sec-Fetch-Dest": "document",
    ...
    def extract_data(json_data):
        ...
        for url in urls:
            if 'https' not in url:
                url = 'https://data.wenzhou.gov.cn/jdop_front/' + url
    ...
    def extract_page_data(self, session_page, item):
        ...
        data_volume = int(session_page.ele('x://tr[td="数据量："]/td[2]').text)
...
if __name__ == '__main__':
    page = WenzhouCrawler(is_headless=True)
    page.run()
