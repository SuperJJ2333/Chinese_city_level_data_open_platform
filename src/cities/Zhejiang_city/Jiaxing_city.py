...
class JiaxingCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '嘉兴市',
                     'province': 'Zhejiang',
                     'total_items_num': 514 + 200,
                     'each_page_count': 10,
                     'base_url': 'https://data.jiaxing.gov.cn/jdop_front/channal/datapubliclist.do'
                     }

        super().__init__(city_info, is_headless)

        self.headers = {"Accept":"application/json, text/javascript, */*; q=0.01","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Content-Length":"133","Content-Type":"application/x-www-form-urlencoded","Cookie":"visited=1; JSESSIONID=F62001B245011938C9D288C58F6FABFC","Host":"data.jiaxing.gov.cn","Origin":"https://data.jiaxing.gov.cn","Referer":"https://data.jiaxing.gov.cn/jdop_front/channal/data_public.do","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","X-Requested-With":"XMLHttpRequest","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    ...
    def process_page(self, urls_list):
        ...
        headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"max-age=0","Connection":"keep-alive","Cookie":"visited=1; JSESSIONID=F62001B245011938C9D288C58F6FABFC","Host":"data.jiaxing.gov.cn","Referer":"https://data.jiaxing.gov.cn/jdop_front/channal/data_public.do","Sec-Fetch-Dest":"document","Sec-Fetch-Mode":"navigate","Sec-Fetch-Site":"same-origin","Sec-Fetch-User":"?1","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    ...
    def extract_data(json_data):
        ...
        for url in urls:
            if 'https' not in url:
                url = 'https://data.jiaxing.gov.cn/jdop_front/' + url
    ...
    def extract_page_data(self, session_page, item):
        ...
        open_conditions = session_page.ele('x://tr[td="开放条件："]/td[2]').text
...
if __name__ == '__main__':
    page = JiaxingCrawler(is_headless=True)
    page.run()
