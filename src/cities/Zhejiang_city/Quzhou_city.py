...
class QuzhouCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        city_info = {'name': '衢州市',
                     'province': 'Zhejiang',
                     'total_items_num': 1332 + 200,
                     'each_page_count': 10,
                     'base_url': 'https://data.qz.gov.cn/jdop_front/channal/datapubliclist.do'

                     }

        super().__init__(city_info, is_headless)

        self.headers = {"Accept":"application/json, text/javascript, */*; q=0.01","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Connection":"keep-alive","Content-Length":"139","Content-Type":"application/x-www-form-urlencoded","Cookie":"visited=1; arialoadData=false; ZJZWFWSESSIONID=e5e0577a-ab9e-4196-8533-0ce0018aebc5","Host":"data.qz.gov.cn","Origin":"https://data.qz.gov.cn","Referer":"https://data.qz.gov.cn/jdop_front/channal/data_public.do","Sec-Fetch-Dest":"empty","Sec-Fetch-Mode":"cors","Sec-Fetch-Site":"same-origin","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","X-Requested-With":"XMLHttpRequest","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}

        self.params = 'pageNumber={page_num}&pageSize=10&type=&type=1&domainId=0&deptId=&regionId=&keyword=&content=&searchString=&orderDefault=&isDownload=1&dimensionId=0'
    ...
    def process_page(self, urls_list):
        ...
        headers = {"Accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","Accept-Encoding":"gzip, deflate, br, zstd","Accept-Language":"zh-CN,zh;q=0.9,en;q=0.8,en-GB;q=0.7,en-US;q=0.6","Cache-Control":"max-age=0","Connection":"keep-alive","Cookie":"visited=1; arialoadData=false; ZJZWFWSESSIONID=7b06f8a8-f95b-47dc-af39-f1b4bff6cf57","Host":"data.qz.gov.cn","Referer":"https://data.qz.gov.cn/jdop_front/channal/data_public.do","Sec-Fetch-Dest":"document","Sec-Fetch-Mode":"navigate","Sec-Fetch-Site":"same-origin","Sec-Fetch-User":"?1","Upgrade-Insecure-Requests":"1","User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36 Edg/126.0.0.0","sec-ch-ua":"\"Not/A)Brand\";v=\"8\", \"Chromium\";v=\"126\", \"Microsoft Edge\";v=\"126\"","sec-ch-ua-mobile":"?0","sec-ch-ua-platform":"\"Windows\""}
    ...
    def extract_data(json_data):
        ...
        for url in urls:
            if 'https' not in url:
                url = 'https://data.qz.gov.cn/jdop_front/' + url
    ...
    def extract_page_data(self, session_page, item):
        ...
        data_volume = int(session_page.ele('x://tr[td="数据条数："]/td[2]').text)
...
if __name__ == '__main__':
    page = QuzhouCrawler(is_headless=True)
    page.run()
