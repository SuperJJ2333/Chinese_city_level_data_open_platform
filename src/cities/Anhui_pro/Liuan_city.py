...
class LiuanCrawler(PageBase):
    ...
    def __init__(self, is_headless=True):
        ...
        self.headers = {
            ...
            "Cookie": "__jsluid_s=235d772b76e80b1bd02520a9f3d88d7b; __utrace=82b75751a4afd072c8353fc6806baa0a; arialoadData=true; ariawapChangeViewPort=true",
            "Host": "data.luan.gov.cn", "Referer": "https://data.luan.gov.cn/oportal/catalog/index?fileFormat=3&page=1",
    ...
    def extract_page_data(self, session_page, files_type):
        ...
        frame = session_page.ele('x://*[@id="app"]/div[6]/div[2]/div/ul/li/table/tbody')

        title = session_page.ele('x://*[@id="app"]/div[6]/div[1]/div/div/div/div[1]/ul[1]/li/h4').text
        subject = session_page.ele('x://*[@id="app"]/div[6]/div[1]/div/div/div/div[2]/ul/li[2]/span').text
...
if __name__ == '__main__':
    page = LiuanCrawler(is_headless=True)
    page.run()
