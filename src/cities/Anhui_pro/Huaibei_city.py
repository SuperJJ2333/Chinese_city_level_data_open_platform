...
class HuaibeiCrawler(PageBase):
    ...
    def process_views(self):
        ...
        for i in range(1, self.total_page_num):
            ...
            session.post(url=url, headers=self.headers, proxies=self.proxies)
    ...
    def extract_page_data(self, json_data):
        ...
        for item in results['data']:
            ...
            open_conditions = item.get('openConditions', '')  # 假设默认为'无'
...
if __name__ == '__main__':
    page = HuaibeiCrawler(is_headless=True)
    page.run()
